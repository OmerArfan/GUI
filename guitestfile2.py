...
questions = [
    ("Do you like Python?", "yes", "Great! Python is awesome! 😃", "Oh no! Maybe you’ll like it later. 😅"),
    ("Do you enjoy coding?", "yes", "Nice! Coding is fun! 🎉", "That's okay! Maybe you’ll enjoy it soon. "),
    ("Is GUI development interesting?", "yes", "Awesome! GUI makes apps cool! ", "Maybe you'll find it interesting later. "),
    ("Do you prefer tea over coffee?", "no", "Nice! Tea lovers unite! ", "Coffee is great too! "),
